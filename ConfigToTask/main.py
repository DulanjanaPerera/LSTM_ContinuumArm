...
import heapq
import scipy.io
from TrajectoryDataset import TrajectoryDatasetFWD
...
# =====================================================
Lhidden_n = 30
model = KinLSTM(Llayers=1, Lhidden_n=Lhidden_n, Nlayers=1, nhidden=[Lhidden_n, 1]).to(device)
...
plt.plot(epochs, train_vals, label='Train RMSE', marker='o')
plt.plot(epochs, test_vals, label='Test RMSE', marker='s')
plt.xlabel('Epoch')
plt.ylabel('RMSE')
