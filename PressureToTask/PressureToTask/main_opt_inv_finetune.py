...
file_theta = 'C:/Users/dperera/OneDrive - Texas A&M University/TAMU course/NUEN 689 - DL for Engineers/Project/finetune/theta.mat'
file_phi = 'C:/Users/dperera/OneDrive - Texas A&M University/TAMU course/NUEN 689 - DL for Engineers/Project/finetune/phi.mat'
file_p = 'C:/Users/dperera/OneDrive - Texas A&M University/TAMU course/NUEN 689 - DL for Engineers/Project/finetune/p.mat'
file_pressure = 'C:/Users/dperera/OneDrive - Texas A&M University/TAMU course/NUEN 689 - DL for Engineers/Project/finetune/pressure.mat'
...
model.load_state_dict(torch.load('finetune_opr_inv_v2.pt'))
criterion = nn.MSELoss()
# optimizer = torch.optim.Adam(model.parameters(), lr=0.0004950470260369062)
optimizer = torch.optim.Adam(model.parameters(), lr=0.0081255609767449865)
...
torch.save(best_state_dict, 'finetune_opr_inv_v11.pt')
best_model = KinLSTM(Llayers=2, Lhidden_n=89, fc_hidden=[79, 111, 101]).to(device)
best_model.load_state_dict(torch.load('finetune_opr_inv_v11.pt'))
...
plt.grid(True)
plt.tight_layout()
plt.savefig("validation_plot_opt_inv_finetune11.png", dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig("prediction_plot_opt_inv_finetune11.png", dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig("error_plot_opt_inv_finetune11.png", dpi=300, bbox_inches='tight')
plt.close()
