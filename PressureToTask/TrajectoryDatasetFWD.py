    ...
    def __init__(self, angles, positions, pressure, seq_len):
        ...
        for traj_idx in range(num_trajectories):
            for t in range(traj_len - seq_len):
                # input: angles [t : t+seq_len]
                # output: position at time t+seq_len
                # input_seq = angles[traj_idx, t:t+seq_len, :]
                input_seq = pressure[traj_idx, t:t+seq_len, :]
                target_pos = positions[traj_idx, t+seq_len, :]

                # input_seq = positions[traj_idx, t:t + seq_len, :]
                # target_pos = pressure[traj_idx, t + seq_len, :]
